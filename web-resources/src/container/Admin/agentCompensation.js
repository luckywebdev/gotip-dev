...
import AgentCompensationContent from '../../components/Admin/AgentReg/agentCompensation';
...
class AgentCompensation extends Component {
  constructor(props) {
    super(props);
    this.state = {
        logining: false,
...
export default connect(null, mapDispatchToProps)(withRouter(AgentCompensation));
